...
%             
%             preOpt='on';
% 			set(hgui.rms_axes,'visible',preOpt);
% 		    set(hgui.rms_imgh,'visible',preOpt);
% 		    set(hgui.rms_label,'visible',preOpt);
% 			set(hgui.rms_too_soft,'visible',preOpt);
% 			set(hgui.rms_too_loud,'visible',preOpt);
% 		    set(hgui.speed_axes,'visible',preOpt);
% 		    set(hgui.speed_imgh,'visible',preOpt);
% 		    set(hgui.speed_label,'visible',preOpt);
% 			set(hgui.speed_too_slow,'visible',preOpt);
% 		    set(hgui.speed_too_fast,'visible',preOpt);
% 
%             if (~isempty(rmsPeaks))
%                 p.rmsMeanPeak=mean(rmsPeaks);
% %                 p.rmsThresh=p.rmsMeanPeak/4;       %SC !! Adaptive RMS threshold setting. Always updating 
