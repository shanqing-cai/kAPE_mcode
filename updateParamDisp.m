...
set(hgui.rb_showOnlyIncorrect, 'Value', uiConfig.bShowOnlyIncorrect);
set(hgui.rb_varyColor, 'Value', uiConfig.bVaryColor);
set(hgui.rb_showReadyGo, 'Value', ~uiConfig.bShowReadyGo);
