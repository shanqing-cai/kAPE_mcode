...
items={ 'SUBJECT_ID', 'SUBJECT_GENDER', 'SUBJECT_DOB', 'SUBJECT_GROUP', ...
        ...
        'SUST_STAY1_REPS', 'SUST_NOISE_REPS', 'SUST_STAY2_REPS', 'SUST_END_REPS', ...
        'TRIAL_LEN', 'TRIAL_LEN_MAX', ...
        'SAMPLING_RATE', 'FRAME_SIZE', 'DOWNSAMP_FACT', ...
        'MASKING_NOISE_RELATIVE_LEVEL'};
...
%     end
    ...
    elseif isequal(item,'SHIFT_RATIO') || isequal(item,'MOUTH_MIC_DIST') || ...
            ...
            isequal(item, 'SUST_STAY1_REPS') || isequal(item, 'SUST_NOISE_REPS') || ...
            isequal(item, 'SUST_STAY2_REPS') || isequal(item, 'SUST_END_REPS') || ...
            isequal(item, 'MASKING_NOISE_RELATIVE_LEVEL')
        str=strtrim(str);
