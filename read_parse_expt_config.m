...
items={ 'SUBJECT_ID', 'SUBJECT_GENDER', 'SUBJECT_DOB', 'SUBJECT_GROUP', ...
        ...
        'SUST_START_REPS', 'SUST_PRENOISE_REPS', 'SUST_RAMP_REPS', ...
        'SUST_STAY1_REPS', 'SUST_NOISE_REPS', 'SUST_STAY2_REPS', ...
        'SUST_END_REPS', ...
...
%     end
    ...
    elseif isequal(item,'SHIFT_RATIO') || isequal(item,'MOUTH_MIC_DIST') || ...
            ...
            isequal(item, 'SUST_PRENOISE_REPS') || ...
            isequal(item, 'SUST_STAY_REPS') || isequal(item, 'SUST_STAY1_REPS') || isequal(item, 'SUST_NOISE_REPS') || isequal(item, 'SUST_STAY2_REPS') || ...
            isequal(item, 'SUST_END_REPS') || ...
            isequal(item, 'MASKING_NOISE_LEVEL_RELATIVE')
        str=strtrim(str);
